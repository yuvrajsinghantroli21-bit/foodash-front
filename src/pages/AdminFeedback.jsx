...
const SOCKET_URL = "https://fooadash.onrender.com";
...
function AdminFeedback() {
  ...
  const stats = useMemo(() => {
    ...
    const fiveStar = feedbacks.filter((item) => item.rating === 5).length;
    const lowRating = feedbacks.filter((item) => item.rating <= 2).length;
