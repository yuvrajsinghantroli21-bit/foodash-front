    ...
    >
      <main className="px-4 py-7 mx-auto max-w-[1500px] sm:px-6">
        ...
        <div className="flex flex-col gap-5 mb-6 lg:flex-row lg:items-center lg:justify-between">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 mb-3 text-xs font-extrabold text-amber-700 rounded-full bg-amber-50">
              <Inbox size={14} />
              Customer Enquiries
            </div>
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-5 py-3 text-sm font-extrabold bg-white border border-gray-200 rounded-xl text-slate-600 shadow-sm hover:bg-gray-50"
          >
            <RefreshCw size={17} />
            Refresh
          </button>
                    ...
                    <div className="p-5">
                      <div className="flex items-start justify-between gap-3 mb-4">
                        ...
                        <button
                          ...
                          className="flex items-center justify-center w-9 h-9 text-slate-500 transition bg-white border border-gray-200 rounded-xl hover:bg-gray-50 shrink-0"
          ...
          <div className="w-full max-w-2xl overflow-hidden bg-white shadow-[0_20px_60px_rgba(0,0,0,0.25)] rounded-3xl">
            <div className="flex items-start justify-between gap-4 px-6 py-5 border-b border-gray-100">
              ...
              <button
                ...
                className="flex items-center justify-center w-10 h-10 text-slate-500 transition bg-white border border-gray-200 rounded-xl hover:bg-gray-50 shrink-0"
              >
                <X size={19} />
              </button>
            </div>
              ...
              <div className="grid grid-cols-1 gap-3 mb-5 sm:grid-cols-2">
                ...
                <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-[#fbfaf8] sm:col-span-2">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-sm font-extrabold text-slate-700 break-all">
